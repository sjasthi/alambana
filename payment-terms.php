...
<title>Aalambana - Payment Terms</title>
...
<div class="body">
	...
	<script>
		...
		const storedImageUrl = localStorage.getItem('paymentTermsBanner');
		if (storedImageUrl) {
		...
		imageUpload.addEventListener('change', function () {
			...
			if (file && file.type.startsWith('image/')) {
				...
				reader.onload = function (e) {
					...
					localStorage.setItem('paymentTermsBanner', e.target.result);
				};
