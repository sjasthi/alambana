...
<head>
  ...
  ================================================== -->
    ...
    <title>Aalambana - Privacy Policy</title>
...
<![endif]-->
    <div class="body">
        ...
        <script>
            ...
            const storedImageUrl = localStorage.getItem('privacyPolicyBanner');
            if (storedImageUrl) {
            ...
            imageUpload.addEventListener('change', function () {
                ...
                if (file && file.type.startsWith('image/')) {
                    ...
                    reader.onload = function (e) {
                        ...
                        localStorage.setItem('privacyPolicyBanner', e.target.result);
                    };
