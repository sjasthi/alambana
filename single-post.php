...
if (getBlogVisibilityStateFromDatabase($blogId))
...
<head>
  ...
  ================================================== -->
    ...
    <title>
        <?php echo getTitleFromDatabase($blogId); ?>
    </title>
...
<![endif]-->
    <div class="body">
        ...
        <div id="main-container">
            <div class="content">
                <a href="blogs.php" class="btn btn-primary" style="margin-left: 100px;">
                    < Go to Blogs</a>
                        <div class="container">
                            ...
                            <form id="blog_modifiy_form" action="<?php echo $formAction; ?>" method="POST"
                                enctype="multipart/form-data" hidden="hidden">
                                <div id="blog_creation_left">
                                    <label>Blog</label>
                                    <label for="paragraph">Paragraph</label>
                                    <br>
                                    <textarea name="paragraph" rows="9" cols="50"
                                        required><?php echo htmlspecialchars($storyDescription); ?></textarea>
                                </div>
                                <div id="blog_creation_right">
                                    <label>Author Description</label>
                                    <br>
                                    <textarea type="text" name="about_author" maxlength="128" required rows="3"
                                        cols="50"><?php echo htmlspecialchars($aboutAuthor); ?></textarea><br><br>
                                </div>
                                <input type="submit" class="btn btn-primary btn-lg" name="<?php echo $postAction; ?>"
                                    value="Publish">
                            </form>
                            ...
                            <div class="row">
                                <div class="col-md-8 content-block">
                                    <!-- Edit Post Blog Page -->
                                    <li class="pull-left"><a href="edit_post.php?blog_id=<?php echo $blogId; ?>">&larr;
                                            Edit Post header</a></li><br><br>
                                    <!-- Fill Blog Page -->
                                    <?php fill_blog_story($blogId); ?>
                                    <!-- Pagination -->
                                    <ul class="pager">
                                        <li class="pull-left"><a
                                                href="single-post.php?blog_id=<?php echo ($blogId - 1); ?>">&larr; Prev
                                                Post</a></li>
                                        <li class="pull-right"><a
                                                href="single-post.php?blog_id=<?php echo ($blogId + 1); ?>">Next Post
                                                &rarr;</a></li>
                                    </ul>
                                    <section class="post-comments" id="comments">
                                        <!-- Get Count of Blog Comments for Page -->
                                        <?php $comments_counter = get_blog_page_comment_count($blogId); ?>
                                        <h3><i class="fa fa-comment"></i> Comments (
                                    ...
                                    <section class="post-comment-form">
                                        ...
                                        ?>
                                        <form id="blog_create_comment_form" action="<?php echo $formAction; ?>"
                                        ...
                                        <div class="col-md-4 col-sm-4">
                                            ...
                                            <div class="row">
                                                <div class="form-group">
                                                    <div class="col-md-12">
                                                        <textarea name="comment_paragraph" cols="50" rows="4"
                                                ...
                                                <div class="form-group">
                                                    <div class="col-md-12">
                                                        <button type="submit" class="btn btn-primary btn-lg" ;
                                                            name="<?php echo $submitAction; ?>">Submit your
                                                            comment</button>
                                                    </div>
                                                </div>
                                            </div>
