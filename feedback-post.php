...
<![endif]-->
    <div class="body">
        ...
        <div id="main-container">
            <div class="content">
                <a href="index.php" class="btn btn-primary" style="margin-left: 100px;">
                    < Go to Home</a>
                        <div class="container">
                            ...
                            <section class="post-feedbacks" id="feedbacks">
                                ...
                                <h3><i class="fa fa-feedback"></i> feedbacks (
                                    <?php echo $feedbacks_counter ?> )
                                </h3>
                                <ol class="feedbacks">
                            ...
                            <section class="post-feedback-form">
                                ...
                                ?>
                                <form id="feedback_create_feedback_form" action="<?php echo $formAction; ?>"
                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <textarea name="feedback_paragraph" cols="50" rows="4"
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <button type="submit" class="btn btn-primary btn-lg" ;
                                                    name="<?php echo $submitAction; ?>">Submit your feedback</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
