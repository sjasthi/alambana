                            ...
                            <form id="blog_modifiy_form" action="<?php echo $formAction; ?>" method="POST"
                                ...
                                <div id="blog_creation_left">
                                    ...
                                    <textarea name="paragraph" rows="9" cols="50"
                                        required><?php echo "Content of blog should be here"; ?></textarea>
                                </div>
                                ...
                                <div class="col-md-8 content-block">
                                    ...
                                    <ul class="pager">
                                        <li class="pull-left"><a
                                                href="blog-post.php?blog_id=<?php echo ($blogId - 1); ?>">&larr; Prev
                                                Post</a></li>
                                        <li class="pull-center"><a
                                                href="blog-post.php?blog_id=<?php echo ($blogId + 1); ?>">Next Post
                                                &rarr;</a></li>
                                    </ul>
                                    <!-- Fill Blog Page -->
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-12">
                                                    <button type="submit" class="btn btn-primary btn-lg" ;
                                                        name="<?php echo $submitAction; ?>">Submit your comment</button>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
